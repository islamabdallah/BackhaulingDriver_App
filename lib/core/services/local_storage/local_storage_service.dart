...
//    return truckNumberModel;
  ...
  setTruckModel({TruckNumberModel truckNumberModel}) async{
    final SharedPreferences prefs = await SharedPreferences.getInstance();
...
/// set and get fro TripData Object
  getCurrentTrip() async{
    ...
    if (currentTripMap != null) {
      final NotificationModel currentTripData = NotificationModel.fromJson(currentTripMap);
      return currentTripData;
    }
    return null;
  }

  setCurrentTrip({NotificationModel tripModel}) async{
    final SharedPreferences prefs = await SharedPreferences.getInstance();
